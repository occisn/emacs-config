...
;;; This is an adapation of diredfl by Steve Purcell
;;; ------------------------------------------------

(setq *my-init--dired-colors-suffix-only* t) ; 'nil' to colorize also file names in dired (and not only suffixes)

;;; SOURCE : https://github.com/purcell/diredfl/blob/master/diredfl.el
...
(defface diredfl-file-name
  '((((background dark)) (:foreground "White"))  ; before: Yellow
    (t                   (:foreground "Black"))) ; before: Blue
...
(defface diredfl-file-suffix
  '((((background dark)) (:foreground "White")) ; before: #7474FFFF7474 ~ light green
    (t                   (:foreground "Black"))) ; before: DarkMagenta
...
;;; ===
;;; ===============================
;;; === defface :  my additions ===
;;; ===============================

;;; normal
(defface my-init--diredfl-file-name
  '((((background dark)) (:foreground "White"))
    (t                   (:foreground "Blue")))
  "*Face used for file names (without suffixes) in Dired buffers.
This means the base name.  It does not include the `.'."
  :group 'diredfl)
(defvar my-init--diredfl-file-name 'my-init--diredfl-file-name)

;;; Others
;;; (setq my-init--others-extensions '(".ses" ".c" ".zip" ".tex" ".tar"))
;;; (defface my-init--others-filename-face
;;;   '((((background dark)) (:foreground "White"))
;;;     (t                   (:foreground "Black")))
;;;   "")
;;; (defvar my-init--others-filename-face 'my-init--others-filename-face)
;;; (defface my-init--others-suffix-face
;;;   '((((background dark)) (:foreground "White"))
;;;     (t                   (:foreground "Black")))
;;;   "")
;;; (defvar my-init--others-suffix-face 'my-init--others-suffix-face)

;;; Word
(setq my-init--word-extensions '(".doc" ".docx" ".odt"))
(defface my-init--word-face
  '((((background dark)) (:foreground "Blue"))
    (t                   (:foreground "Blue")))
  "")
(defvar my-init--word-face 'my-init--word-face)

;;; Excel
(setq my-init--excel-extensions '(".xls" ".xlsx" ".xlsm" ".ods"))
(defface my-init--excel-face
  '((((background dark)) (:foreground "Green"))
    (t                   (:foreground "Dark Green")))
  "")
(defvar my-init--excel-face 'my-init--excel-face)

;;; Powerpoint
(setq my-init--powerpoint-extensions '(".ppt" ".pptx" ".odp"))
(defface my-init--powerpoint-face
  '((((background dark)) (:foreground "Orange"))
    (t                   (:foreground "Orange")))
  "")
(defvar my-init--powerpoint-face 'my-init--powerpoint-face)

;;; eml
(setq my-init--eml-extensions '(".eml"))
(defface my-init--eml-face 
  '((((background dark)) (:foreground "#7474FFFFFFFF")) ; ~ cyan
    (t                   (:foreground "#7474FFFFFFFF")))
  "")
(defvar my-init--eml-face 'my-init--eml-face)

;;; pdf
(setq my-init--pdf-extensions '(".pdf"))
(defface my-init--pdf-face
  '((((background dark)) (:foreground "Red"))
    (t                   (:foreground "Red")))
  "")
(defvar my-init--pdf-face 'my-init--pdf-face)

;;; exe
(setq my-init--exe-extensions '(".exe"))
(defface my-init--exe-face
  '((((background dark)) (:foreground "Red" :weight bold))
    (t                   (:foreground "Red" :weight bold)))
  "")
(defvar my-init--exe-face 'my-init--exe-face)

;;; org
(setq my-init--org-extensions '( ".md" ".org" ".txt" ".ses"))
(defface my-init--org-face
  '((((background dark)) (:foreground "violet")) ; ~ salmon = #FFFF921F921F
    (t                   (:foreground "#FFFF921F921F")))
  "")
(defvar my-init--org-face 'my-init--org-face)

;;; lisp
(setq my-init--lisp-extensions '(".lisp" ".el"))
(defface my-init--lisp-face
  '((((background dark)) (:foreground "Violet"))
    (t                   (:foreground "Violet")))
  "")
(defvar my-init--lisp-face 'my-init--lisp-face)

;;; image
(setq my-init--image-extensions '(".jpg" ".jpeg" ".png" ".gif"))
(defface my-init--image-face
  '((((background dark)) (:foreground "Gray" :slant italic))
    (t                   (:foreground "Gray" :slant italic)))
  "")
(defvar my-init--image-face 'my-init--image-face)

;;; old
(setq my-init--old-extensions '(".old" ".bak" ".org~" ".el~"))
(defface my-init--old-face
  '((((background dark)) (:foreground "Gray" :slant italic))
    (t                   (:foreground "Gray" :slant italic)))
  "")
(defvar my-init--old-face 'my-init--old-face)
...
(defconst diredfl-font-lock-keywords-1
  ...
  (list
   ...
   ;;   ("\\(.+\\)$" nil nil (0 my-init--diredfl-file-name keep t)))

   ;; others
   ;; `(,dired-move-to-filename-regexp
   ;;   (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
   ;;   (2 diredfl-date-time t t) ; Date/time, ISO
   ;;   (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--others-extensions)
   ;;                                   "\\)[*]?$"))
   ;;    nil nil (0 my-init--others-filename-face keep t))) 
   ;; (list (concat "\\(" (concat (funcall #'regexp-opt my-init--others-extensions) "\\)[*]?$"))
   ;;       1 my-init--others-suffix-face t)
  ...
  "2nd level of Dired highlighting.  See `font-lock-maximum-decoration'.") ; end of defconst
...
;;; word
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--word-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--word-face keep t)))
   diredfl-font-lock-keywords-1
   ))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--word-extensions) "\\)[*]?$"))
       1 my-init--word-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--excel-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--excel-face keep t)))
   diredfl-font-lock-keywords-1)) 
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--excel-extensions) "\\)[*]?$"))
       1 my-init--excel-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--powerpoint-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--powerpoint-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--powerpoint-extensions) "\\)[*]?$"))
       1 my-init--powerpoint-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--eml-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--eml-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--eml-extensions) "\\)[*]?$"))
       1 my-init--eml-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--pdf-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--pdf-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--pdf-extensions) "\\)[*]?$"))
       1 my-init--pdf-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--exe-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--exe-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--exe-extensions) "\\)[*]?$"))
       1 my-init--exe-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--org-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--org-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--org-extensions) "\\)[*]?$"))
       1 my-init--org-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--lisp-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--lisp-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--lisp-extensions) "\\)[*]?$"))
       1 my-init--lisp-face t)
 diredfl-font-lock-keywords-1)
...
(unless *my-init--dired-colors-suffix-only*
  (push
   `(,dired-move-to-filename-regexp
     (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
     (2 diredfl-date-time t t) ; Date/time, ISO
     (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--image-extensions)
                                     "\\)[*]?$"))
      nil nil (0 my-init--image-face keep t)))
   diredfl-font-lock-keywords-1))
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--image-extensions) "\\)[*]?$"))
       1 my-init--image-face t)
 diredfl-font-lock-keywords-1)
...
(push
 `(,dired-move-to-filename-regexp
   (7 diredfl-date-time t t) ; Date/time, locale (western or eastern)
   (2 diredfl-date-time t t) ; Date/time, ISO
   (,(concat "\\(.+\\)\\(" (concat (funcall #'regexp-opt my-init--old-extensions)
                                   "\\)[*]?$"))
    nil nil (0 my-init--old-face keep t)))
 diredfl-font-lock-keywords-1)
(push
 (list (concat "\\(" (concat (funcall #'regexp-opt my-init--old-extensions) "\\)[*]?$"))
       1 my-init--old-face t)
 diredfl-font-lock-keywords-1)
...
(define-globalized-minor-mode diredfl-global-mode diredfl-mode
  (lambda ()
    (when (derived-mode-p 'dired-mode)
      (diredfl-mode)))
  :require 'my-init--diredfl)

(my-init--message-package-loaded "my-init--diredfl")

(provide 'my-init--diredfl)
